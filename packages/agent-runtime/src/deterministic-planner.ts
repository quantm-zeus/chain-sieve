  ...
  public static plan(input: PlannerInput): DeterministicPlan {
    ...
    const planDataForHash = {
      ...
      envelope: {
        ...
        allowedChains: envelope.allowedChains,
        allowedAddresses: envelope.allowedAddresses,
        timeRange: envelope.timeRange,
        maxLimit: envelope.maxLimit,
        maxOutputSizeBytes: envelope.maxOutputSizeBytes,
        maxCostUsd: envelope.maxCostUsd,
      },
      budget: {
        maxSteps: budget.maxSteps,
        maxToolCalls: budget.maxToolCalls,
        maxToolCallsPerCandidate: budget.maxToolCallsPerCandidate,
        maxProviderCalls: budget.maxProviderCalls,
        maxInputTokens: budget.maxInputTokens,
        maxOutputTokens: budget.maxOutputTokens,
        maxModelCostUsd: budget.maxModelCostUsd,
        maxProviderCostUnits: budget.maxProviderCostUnits,
      },
      steps: steps.map((s) => ({
