...
describe('bootstrap core', () => {
  it('validates configuration and pins synthetic shadow mode', () => { expect(loadConfig({ NODE_ENV: 'test' }).CAPABILITY_MODE).toBe('SYNTHETIC_SHADOW'); expect(() => loadConfig({ API_PORT: '0' })).toThrow(); });
