# T-G0-CORE ZCode task goal

Implement exactly one task: `T-G0-CORE` in cluster `C-G0-IMPLEMENTATION`.
...
- Context pack: `artifacts/context/T-G0-CORE`
- Context manifest SHA-256: `8f3e50bc929f40c26562cbf46fa68700dc5b4be5ae5b9d9e842667b4e5b7c2d3`
- Context aggregate SHA-256: `36357e4817107ddb2ca393ae730f56a71b376d1950a5357a421af5a8aae6ad29`
...
- Requirements: `FR-CORE-001`, `FR-CORE-002`, `FR-CORE-003`, `FR-CORE-004`, `FR-CORE-005`, `FR-CORE-006`, `FR-CORE-007`, `FR-CORE-008`
- Acceptance criteria: `AC-001`, `AC-004`, `AC-245`
- Dependencies: none
- Path locks: `packages/domain/public-api`
...
- `tests/negative/AC-001.negative.spec.ts`
- `tests/acceptance/AC-004.spec.ts`
- `tests/negative/AC-004.negative.spec.ts`
- `tests/acceptance/AC-245.spec.ts`
- `tests/negative/AC-245.negative.spec.ts`
...
pnpm spec:verify
pnpm task:begin T-G0-CORE --holder <holder> --lease-version <version>
pnpm exec vitest run tests/acceptance/AC-001.spec.ts tests/negative/AC-001.negative.spec.ts tests/acceptance/AC-004.spec.ts tests/negative/AC-004.negative.spec.ts tests/acceptance/AC-245.spec.ts tests/negative/AC-245.negative.spec.ts
pnpm architecture:verify
pnpm prohibited-capabilities:scan
pnpm task:self-review T-G0-CORE --holder <holder> --lease-version <version>
pnpm task:verify T-G0-CORE --holder <holder> --lease-version <version>
# Return to /Users/quantm/Documents/My Projects/chain-sieve-worktrees/g0 on cluster/g0.
pnpm merge-queue:add T-G0-CORE
...
```sh
pnpm task:renew T-G0-CORE --holder <holder> --lease-version <version>
```
