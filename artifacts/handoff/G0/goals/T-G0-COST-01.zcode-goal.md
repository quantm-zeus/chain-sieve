# T-G0-COST-01 ZCode task goal

Implement exactly one task: `T-G0-COST-01` in cluster `C-G0-IMPLEMENTATION`.
...
- Context pack: `artifacts/context/T-G0-COST-01`
- Context manifest SHA-256: `6d62483b510ec5803e562b5b384f144d47142fe6a7f9591ba041666347152f84`
- Context aggregate SHA-256: `87eb69a295d370419e676b9b8c0826922b2ac6469b15d8e73b2552b887f2c638`
...
- Requirements: `FR-COST-001`, `FR-COST-002`, `FR-COST-003`, `FR-COST-004`, `FR-COST-005`, `FR-COST-006`, `FR-COST-007`, `FR-COST-008`
- Acceptance criteria: `AC-100`, `AC-103`
- Dependencies: none
...
Required tests:
- `tests/acceptance/AC-100.spec.ts`
- `tests/negative/AC-100.negative.spec.ts`
- `tests/acceptance/AC-103.spec.ts`
- `tests/negative/AC-103.negative.spec.ts`
...
pnpm spec:verify
pnpm task:begin T-G0-COST-01 --holder <holder> --lease-version <version>
pnpm exec vitest run tests/acceptance/AC-100.spec.ts tests/negative/AC-100.negative.spec.ts tests/acceptance/AC-103.spec.ts tests/negative/AC-103.negative.spec.ts
pnpm architecture:verify
pnpm prohibited-capabilities:scan
pnpm task:self-review T-G0-COST-01 --holder <holder> --lease-version <version>
pnpm task:verify T-G0-COST-01 --holder <holder> --lease-version <version>
# Return to /Users/quantm/Documents/My Projects/chain-sieve-worktrees/g0 on cluster/g0.
pnpm merge-queue:add T-G0-COST-01
...
```sh
pnpm task:renew T-G0-COST-01 --holder <holder> --lease-version <version>
```
