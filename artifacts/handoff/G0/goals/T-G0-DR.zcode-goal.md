# T-G0-DR ZCode task goal

Implement exactly one task: `T-G0-DR` in cluster `C-G0-IMPLEMENTATION`.
...
- Context pack: `artifacts/context/T-G0-DR`
- Context manifest SHA-256: `9eb8f2e9b3a7c5b597713124610d2cd8226147e2f1bab589bb48d5f377f74dc1`
- Context aggregate SHA-256: `d525aff792ce26b2735260a9648e190c8d4e89de3f89fe85ad3a230bdc634441`
...
- Requirements: `FR-DR-001`, `FR-DR-002`
- Acceptance criteria: `AC-060`, `AC-062`, `AC-263`
- Dependencies: none
...
Required tests:
- `tests/acceptance/AC-060.spec.ts`
- `tests/negative/AC-060.negative.spec.ts`
- `tests/acceptance/AC-062.spec.ts`
- `tests/negative/AC-062.negative.spec.ts`
- `tests/acceptance/AC-263.spec.ts`
- `tests/negative/AC-263.negative.spec.ts`
...
pnpm spec:verify
pnpm task:begin T-G0-DR --holder <holder> --lease-version <version>
pnpm exec vitest run tests/acceptance/AC-060.spec.ts tests/negative/AC-060.negative.spec.ts tests/acceptance/AC-062.spec.ts tests/negative/AC-062.negative.spec.ts tests/acceptance/AC-263.spec.ts tests/negative/AC-263.negative.spec.ts
pnpm architecture:verify
pnpm prohibited-capabilities:scan
pnpm task:self-review T-G0-DR --holder <holder> --lease-version <version>
pnpm task:verify T-G0-DR --holder <holder> --lease-version <version>
# Return to /Users/quantm/Documents/My Projects/chain-sieve-worktrees/g0 on cluster/g0.
pnpm merge-queue:add T-G0-DR
...
```sh
pnpm task:renew T-G0-DR --holder <holder> --lease-version <version>
```
