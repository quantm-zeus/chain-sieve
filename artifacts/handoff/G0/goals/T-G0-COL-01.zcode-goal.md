# T-G0-COL-01 ZCode task goal

Implement exactly one task: `T-G0-COL-01` in cluster `C-G0-IMPLEMENTATION`.
...
- Context pack: `artifacts/context/T-G0-COL-01`
- Context manifest SHA-256: `f88311815d0b3be67b0fedc5f9e2ea87694b858b2859fe6d8da907a558c0789f`
- Context aggregate SHA-256: `562ff84a3393f34035991d60dbeed80874e68f40fee7a8a534380392e0fa79fa`
...
- Requirements: `FR-COL-001`, `FR-COL-002`, `FR-COL-003`, `FR-COL-004`, `FR-COL-005`, `FR-COL-006`, `FR-COL-007`, `FR-COL-008`
- Acceptance criteria: `AC-110`, `AC-225`, `AC-230`, `AC-237`
- Dependencies: none
...
Required tests:
- `tests/acceptance/AC-110.spec.ts`
- `tests/negative/AC-110.negative.spec.ts`
- `tests/acceptance/AC-225.spec.ts`
- `tests/negative/AC-225.negative.spec.ts`
- `tests/acceptance/AC-230.spec.ts`
- `tests/negative/AC-230.negative.spec.ts`
- `tests/acceptance/AC-237.spec.ts`
- `tests/negative/AC-237.negative.spec.ts`
...
pnpm spec:verify
pnpm task:begin T-G0-COL-01 --holder <holder> --lease-version <version>
pnpm exec vitest run tests/acceptance/AC-110.spec.ts tests/negative/AC-110.negative.spec.ts tests/acceptance/AC-225.spec.ts tests/negative/AC-225.negative.spec.ts tests/acceptance/AC-230.spec.ts tests/negative/AC-230.negative.spec.ts tests/acceptance/AC-237.spec.ts tests/negative/AC-237.negative.spec.ts
pnpm architecture:verify
pnpm prohibited-capabilities:scan
pnpm task:self-review T-G0-COL-01 --holder <holder> --lease-version <version>
pnpm task:verify T-G0-COL-01 --holder <holder> --lease-version <version>
# Return to /Users/quantm/Documents/My Projects/chain-sieve-worktrees/g0 on cluster/g0.
pnpm merge-queue:add T-G0-COL-01
...
```sh
pnpm task:renew T-G0-COL-01 --holder <holder> --lease-version <version>
```
