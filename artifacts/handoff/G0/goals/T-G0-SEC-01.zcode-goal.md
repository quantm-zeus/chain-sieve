# T-G0-SEC-01 ZCode task goal

Implement exactly one task: `T-G0-SEC-01` in cluster `C-G0-IMPLEMENTATION`.
...
- Context pack: `artifacts/context/T-G0-SEC-01`
- Context manifest SHA-256: `d351d996fabd0ec1c0938fbd669b112f56f699a58667c41c020201bbfe060ce7`
- Context aggregate SHA-256: `cf56d8044afd090f15f6e7422095cd63443693feb3acc1d1e8941eda61b51224`
...
- Acceptance criteria: `AC-050`, `AC-053`, `AC-259`
- Dependencies: none
- Path locks: `packages/security/public-api`
...
- `tests/acceptance/AC-053.spec.ts`
- `tests/negative/AC-053.negative.spec.ts`
...
pnpm spec:verify
pnpm task:begin T-G0-SEC-01 --holder <holder> --lease-version <version>
pnpm exec vitest run tests/acceptance/AC-050.spec.ts tests/negative/AC-050.negative.spec.ts tests/acceptance/AC-053.spec.ts tests/negative/AC-053.negative.spec.ts tests/acceptance/AC-259.spec.ts tests/negative/AC-259.negative.spec.ts
pnpm architecture:verify
pnpm prohibited-capabilities:scan
pnpm task:self-review T-G0-SEC-01 --holder <holder> --lease-version <version>
pnpm task:verify T-G0-SEC-01 --holder <holder> --lease-version <version>
# Return to /Users/quantm/Documents/My Projects/chain-sieve-worktrees/g0 on cluster/g0.
pnpm merge-queue:add T-G0-SEC-01
...
```sh
pnpm task:renew T-G0-SEC-01 --holder <holder> --lease-version <version>
```
