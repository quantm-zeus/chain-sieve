# C-G6-IMPLEMENTATION zcode-fix-goal

Fix only the findings in the latest cluster review. The immutable contract is `C-G6-IMPLEMENTATION.contract.json`. Validate source hashes before work.
