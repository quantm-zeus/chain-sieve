...
Independently review the completed cluster and produce PASS or CHANGES_REQUIRED. The immutable contract is `C-G6-IMPLEMENTATION.contract.json`. Validate source hashes before work.
