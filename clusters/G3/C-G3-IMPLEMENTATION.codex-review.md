...
Independently review the completed cluster and produce PASS or CHANGES_REQUIRED. The immutable contract is `C-G3-IMPLEMENTATION.contract.json`. Validate source hashes before work.
